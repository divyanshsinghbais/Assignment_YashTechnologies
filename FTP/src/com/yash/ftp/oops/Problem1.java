...
class Employee extends Person {
	...
	public Employee(int pid, String pname, String paddress, String dob, String date_of_joining, String base_location,
		...
		this.arr = arr;
		System.out.println("\nEmployee class details are below:");
...
class Problem1 {
    public static void main(String args[]) {
       ...
       arr[1] = new Department(13, "C#");


       Employee e = new Employee(101, "Divyansh", "222 abc", "10-11-1996", "23-09-12", "Indore", "java",
                "797436733", "divyanshsingbais@hotmail.com", Arrays.toString(arr));
       
        Customer c = new Customer(101, "Divyansh", "217 rajiv awas", "15-04-1993", "12-02-12", "rajiv awas", 843554,
                "deepesh94@gmal.com");
